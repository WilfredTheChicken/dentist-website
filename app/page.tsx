...
export default function Home() {
  return <main>
    ...
    <section className="hero section-wrap">
      <div className="hero-copy"><p className="eyebrow">DENTISTRY FOR YOUR WHOLE FAMILY</p><h1>Modern dentistry.<br/><i>Thoughtful care.</i></h1><p className="hero-text">Clear guidance, careful treatment, and a smile that still feels like your own.</p><a className="button button-dark" href={zocdocUrl} target="_blank" rel="noopener noreferrer">Book your visit <ArrowRight size={17}/></a><div className="hero-meta" aria-label="Office contact information"><div className="hero-contact-column"><div className="hero-contact-item"><Phone size={18} aria-hidden="true"/><a href="tel:+17182277400"><strong>Phone</strong><span>(718) 227-7400</span></a></div><div className="hero-contact-item"><Mail size={18} aria-hidden="true"/><a href="mailto:info@dentistryonveterans.com"><strong>Email</strong><span>info@dentistryonveterans.com</span></a></div></div><div className="hero-contact-column"><div className="hero-contact-item"><MapPin size={18} aria-hidden="true"/><div><strong>Address</strong><address>2955 Veterans Rd W<br/>Staten Island, NY 10309</address></div></div><div className="hero-contact-item hero-hours"><Clock size={18} aria-hidden="true"/><div><strong>Office Hours</strong><dl><div><dt>Saturday</dt><dd>9:00 AM – 4:00 PM</dd></div><div><dt>Sunday</dt><dd>Closed</dd></div><div><dt>Monday</dt><dd>9:00 AM – 8:00 PM</dd></div><div><dt>Tuesday</dt><dd>9:00 AM – 7:00 PM</dd></div><div><dt>Wednesday</dt><dd>9:00 AM – 8:00 PM</dd></div><div><dt>Thursday</dt><dd>9:00 AM – 5:00 PM</dd></div><div><dt>Friday</dt><dd>9:00 AM – 5:00 PM</dd></div></dl></div></div></div></div></div>
