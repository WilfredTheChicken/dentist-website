...
export default function Home() {
  ...
  return <main className="overflow-x-hidden bg-[#f8f7f4] text-[#173c3a]">
    ...
    <section id="top" className="hero section-wrap">
      ...
      <div className="hero-art"><img src="/hero-dental.png" alt="Dentist speaking with a smiling patient in a bright treatment room"/><div className="hero-note"><Sparkles size={16}/><span>Care that starts<br/>with listening.</span></div></div>
    </section>
